 ...
 * Copyright (c) 2009-2011 by butterworth, Inc. All Rights Reserved.
...
//@interface butterworthObject : NSObject
//@end

@interface butterworthObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[butterworthObject class]])
		{
			for (NSString *key in [[(butterworthObject*)o modules] allKeys])
			{
