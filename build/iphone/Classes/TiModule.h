...
/**
 The base class for all butterworth modules
 */
...
/**
 butterworth Platform calls this method on startup.
 */
-(void)startup;

/**
 butterworth Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 butterworth Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 butterworth Platform calls this method on resume.
 @param sender The sender of the event.
 */
