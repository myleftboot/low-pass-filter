...
@interface butterworthObject : KrollCoverageObject {
#else
@interface butterworthObject : KrollObject {
#endif
@private
...
extern NSString * butterworth$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	butterworthObject *_butterworth;
	BOOL shutdown;
