...
// in simulator we redefine to format for butterworth Developer console
...
{\
	NSString * exceptionName = [@"org.butterworth." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.butterworth";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIbutterworthNativeItemNone = -1, 
	UIbutterworthNativeItemSpinner = -2,
	UIbutterworthNativeItemProgressBar = -3,
	
	UIbutterworthNativeItemSlider = -4,
	UIbutterworthNativeItemSwitch = -5,
	UIbutterworthNativeItemMultiButton = -6,
	UIbutterworthNativeItemSegmented = -7,
	
	UIbutterworthNativeItemTextView = -8,
	UIbutterworthNativeItemTextField = -9,
	UIbutterworthNativeItemSearchBar = -10,
	
	UIbutterworthNativeItemPicker = -11,
	UIbutterworthNativeItemDatePicker = -12,
	
	UIbutterworthNativeItemInfoLight = -13,
	UIbutterworthNativeItemInfoDark = -14,
	
	UIbutterworthNativeItemDisclosure = -15,
	
	UIbutterworthNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all butterworth instances of
